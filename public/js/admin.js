  ...
  try {
    ...
    renderLogsList: function(logs) {
        ...
        container.innerHTML = logs.map(log => {
            ...
            return `
                <div class="console-log-item ${levelClass}">
                    <div class="console-log-line" onclick="this.classList.toggle('expanded')">
                        ...
                        ${log.data ? `<span class="console-expand-icon"><i class="fas fa-chevron-down"></i></span>` : ''}
                    </div>
                    ${log.data ? `
                        <div class="console-log-data">
                            <div class="console-data-toggle" onclick="event.stopPropagation();this.classList.toggle('show')">
                                <span class="console-data-title">数据详情</span>
