...
const userManager = {
  ...
  applyTheme: function(theme) {
    ...
    // 定义主题变量（与 style.css :root 设计体系一致：校园蓝 + 直角；
    // 浅色 = style.css 默认值，深色 = 同色相暗色变体）
    const themes = {
      light: {
        ...
        '--info-color': '#1971c2',
        '--info-dark': '#1864ab',
        '--favorite-color': '#e67700',
        '--favorite-dark': '#d9480f',
        '--dislike-color': '#d6336c',
        '--dislike-dark': '#c2255c',
        '--icon-color': '#57606a',
        ...
        '--code-border': '#e4e6e8',
        '--code-header-bg': '#2f3a45',
        '--code-text': '#1f2328',
        '--button-text': '#ffffff'
      },
      dark: {
        '--primary-color': '#5a9bdd',
        '--primary-light': '#1e2f42',
        '--primary-dark': '#6fabe2',
        '--secondary-color': '#4a7fa8',
        '--text-color': '#e2e8f0',
        '--text-light': '#94a3b8',
        '--text-muted': '#64748b',
        '--background-light': '#0f172a',
        '--background-card': '#1e293b',
        '--background-hover': '#2a3648',
        '--border-color': '#334155',
        '--border-light': '#2a3648',
        ...
        '--favorite-dark': '#e67700',
        '--dislike-color': '#f472b6',
        '--dislike-dark': '#d6336c',
        '--icon-color': '#94a3b8',
