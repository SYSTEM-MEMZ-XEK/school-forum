...
// 管理员功能 - 获取IP访问统计列表
router.get('/admin/ip-stats', requireAdmin, adminController.getIpStats);

// 管理员功能 - 获取IP访问统计摘要
router.get('/admin/ip-stats/summary', requireAdmin, adminController.getIpStatsSummary);

// 管理员功能 - 清除指定IP统计
router.delete('/admin/ip-stats/:ip', requireAdmin, adminController.clearIpStats);
