...
// 发送密码修改验证码（需要验证当前密码）
router.post('/send-password-change-code', userController.sendPasswordChangeCode);

// 验证密码修改验证码
router.post('/verify-password-change-code', userController.verifyPasswordChangeCode);
